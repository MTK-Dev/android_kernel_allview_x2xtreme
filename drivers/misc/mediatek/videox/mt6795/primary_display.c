...
{
    DISP_REG_SET(NULL, DISP_REG_CONFIG_DISP_OVL1_MOUT_EN, 0x0);
    DISP_REG_SET(NULL, DISP_REG_CONFIG_DISP_GAMMA_MOUT_EN, 0x0);
}

void primary_restore_mira_config (void)
{
    DISP_REG_SET(NULL, DISP_REG_CONFIG_DISP_OVL1_MOUT_EN, 0x1);
    DISP_REG_SET(NULL, DISP_REG_CONFIG_DISP_GAMMA_MOUT_EN, 0x4);
    DISP_REG_SET(NULL, DISP_REG_CONFIG_DISP_WDMA1_SEL_IN, 0x1);
}
...
int primary_display_suspend(void)
{
    ...
    //dpmgr_path_disconnect(pgc->dpmgr_sub_mem_path_handle, CMDQ_DISABLE);
